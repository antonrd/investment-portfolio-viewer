class ComputeSummaries {
  ...
  _computeSummaries(){
    ...
    for (let symbol in this.stock_details) {
      ...
      let annual_yield = this.stock_events[symbol].annual_yield;
  ...
  _computeDividendStats() {
    for (let symbol in this.stock_events){
      ...
      let annual_yield = this._computeAnnualYield(today, buy_events, total_yield);
      this.stock_events[symbol] = {dividends_total, annual_yield};
    }
  }

  _computeAnnualYield(today, buy_events, total_yield) {
