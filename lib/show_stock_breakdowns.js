class ShowStockBreakdowns {
  ...
  _showTotalBreakdown(all_breakdown) {
    ...
    $('.stock-breakdowns-all').append("<tr><th>Total value</th><th>Unrealized P/L</th><th>Unrealized P/L %</th><th>Realized P/L</th><th>Realized P/L %<th>Weighted cost</th><th>Weighted P/L %</th><th>Dividends</th><th>Gain</th></tr>")
    $('.stock-breakdowns-all').append(this._totalStats(all_breakdown));
  }

  _totalStats(all_breakdown) {
    let total_income = all_breakdown.unrealized_pl + all_breakdown.realized_pl + all_breakdown.total_dividends;
    return `<tr><td>$ ${MathHelpers.round2(all_breakdown.total_value)}
      ...
      </td><td>$${MathHelpers.round2(total_income)}
      </td></tr>`;
  }
