class ShowStockSummaries {
  ...
  show() {
    ...
    $('.stock-summaries').append("<tr><th>Symbol</th><th>Value</th><th>Amount</th><th>Date</th><th>Unrealized P/L</th><th>Unrealized P/L %</th><th>Realized P/L</th><th>Realized P/L %</th><th>Price</th><th>Average buy price</th><th>Average sell price</th><th>Dividends total</th><th>Yield</th><th>Portion</th></tr>");
